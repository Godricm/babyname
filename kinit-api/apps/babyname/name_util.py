from apps.babyname.name_set import get_source
from apps.babyname.wuge import check_wuge_config, get_stroke_list


def get_name():
    name_source = int(
        input("请选择词库，0: 默认, 1: 诗经, 2: 楚辞, 3: 论语, 4: 周易, 5: 唐诗, 6: 宋诗, 7: 宋词。请选择："))
